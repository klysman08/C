...
class Cliente : public Publicacoes
{
	...
	void setCodigo () // fun��o para gerar cod�do ao cliente
	{
		int num;
...
{
	int i; // ser� usada no for para quantidade de assinaturas que o cliente desejou;
	string publicacao; // para armaznenar o nome da assinatura;
	int edicoes; //numero de semanas que a publica��o ser� enviada
	int assinaturas; //quantidade da mesma publica��o a ser recebida
	string nome;
	int idade;
	string endereco;
